function U = poten_cal_2d(P, delta_x, delta_y, c_0, omega) %c_0は媒質の音速, fは音波の周波数, rho_pは微小物体の密度, rho_0は媒質の密度, V_pは微小物体の体積
    ...
    [p_x, p_y] = gradient(P,delta_x,delta_y);  
%     
    laplacianP = abs(p_x).^2+abs(p_y).^2;
