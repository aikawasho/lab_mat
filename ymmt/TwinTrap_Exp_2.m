...
function TwinTrap_Exp_2(zp, range, range_N, hemis_r, xslice, yslice, zslice, sp_number, saveName, movefilename, titleName)
...
%                   end
    ...
    view(90,0)
    name =strcat('bottleTrapDesign_R',num2str(hemis_r),'N',num2str(howmany_sp)); 
...
%     movefile(strcat('kakuninup_z',num2str(nameIndex),'.png'), movefilename);
    ...
    name =strcat('bottleTrapDesign_R_',num2str(hemis_r),'N',num2str(howmany_sp),'.fig'); 
    saveas(gcf,name);
