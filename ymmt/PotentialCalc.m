function U = PotentialCalc(X, Y, Z, P,slice_x, slice_y, slice_z, delta_x, delta_y, delta_z, c_0, c_p, f, rho_0, rho_p, V_p) %c_0は媒質の音速, fは音波の周波数, rho_pは微小物体の密度, rho_0は媒質の密度, V_pは微小物体の体積
