...
function CalcFxFyFz_3(X, Y, Z, U, delta_x, delta_y, delta_z ,slice_x, slice_y, slice_z, saveName, movefileName) %c_0は媒質の音速, fは音波の周波数, rho_pは微小物体の密度, rho_0は媒質の密度, V_pは微小物体の体積
    %各パラメータ設定
